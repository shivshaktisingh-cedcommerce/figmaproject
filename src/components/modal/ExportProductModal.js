...
function ModalWithPrimaryAndSecondaryActionsExampleExport() {
  ...
  const activator = <Button plain onClick={handleModalChange}>Export products</Button>;
...
export default ModalWithPrimaryAndSecondaryActionsExampleExport